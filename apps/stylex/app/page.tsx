...
import { colors, fonts, radii } from "@workspace/craft-ds-stylex/tokens.stylex";
...
import { Layout } from "@workspace/craft-ds-stylex/ds";
...
export default function RootLayout({ children }) {
  return <Layout>{children}</Layout>;
      ...
      <Prose.Pre>
        <Prose.Code
          block
        >{`import { Prose } from "@workspace/craft-ds-stylex/ds";
