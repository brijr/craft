...
export const Prose = ({
  ...
  return (
    <Component
      className={cn(
        // Base classes
        "min-w-0 antialiased text-base leading-7",
        // Heading styles
        ...
        // Tables
        "[&_table]:w-full [&_table]:table-fixed [&_table]:my-4 [&_table]:overflow-hidden [&_table]:rounded-sm [&_table]:border",
        "[&_thead]:bg-muted/50",
        "[&_tr]:border-b [&_tr:nth-child(even)]:bg-muted/20",
        "[&_th]:break-words [&_th]:px-4 [&_th]:py-3 [&_th]:text-left [&_th]:font-semibold [&_th]:border-r",
        "[&_td]:break-words [&_td]:px-4 [&_td]:py-2 [&_td]:border-r",
        // Media
